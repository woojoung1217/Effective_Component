...
1. 사용법이 어렵다
2. 문서화 된 내용이 없어서 처음 보면 접근하기 힘들다.
3. 재사용하기 위해 만들었지만 그냥 순수한 태그를 사용하는 편이 더 쉽다 => 사용하기 불편
4. 스타일이 변경(디자인) 대응하기 어렵다. => 유지보수가 어렵다.
...
이러한 문제들을 해결 하기 위해 향후 프로젝트에서 개선할 수 있는 방법을 연습 합니다.
